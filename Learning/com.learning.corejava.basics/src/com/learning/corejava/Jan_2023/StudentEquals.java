...
public class StudentEquals {
    ...
    public static void main(String... args) {
        ...
        System.out.println("Lets print the hashcode");
    ...
    // Hash-code is unique integer. It is associated with every object. (same like inode concept in linux)
    @Override
    public int hashCode() {
        return 10 * this.rollNo;
    }
}